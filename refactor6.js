...
let code = fs.readFileSync(scraperPath, 'utf8').replace(/\r\n/g, '\n');
...
const extractPlayableVideoUrl = extractAndRemove('extractPlayableVideoUrl', 'async function extractPlayableVideoUrl', '        }\n    }\n}\n');
const extractMetadata = extractAndRemove('extractMetadata', '            // --- META EXTRACTOR FUNCTION ---\n            const extractMetadata = async', '}, passedBody).catch(() => null);\n            };\n');
...
let backfillCode = fs.readFileSync(backfillPath, 'utf8').replace(/\r\n/g, '\n');
